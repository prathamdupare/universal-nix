{
  ...
  outputs = inputs@{ self, nix-darwin, nixpkgs, home-manager, nix-snapd, ... }: {
    ...
    # -----------------------------------
    # 3. Standalone Home-Manager (Arch / any Linux)
    # -----------------------------------
    homeConfigurations.pratham = home-manager.lib.homeManagerConfiguration {
      pkgs = nixpkgs.legacyPackages.x86_64-linux;
      extraSpecialArgs = { inherit inputs; standalone = true; };
      modules = [ ./home.nix ];
    };
